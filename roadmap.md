...
## المرحلة 8 — التدقيق الشامل للمنتج (قيد التنفيذ)
- [ ] P0: توحيد مصادر بيانات الكادر والتحقق من التخصص والمسمى والموقع وحالة التوثيق
- [ ] P0: جعل بحث المرشحين وخصم الحصة عملية واحدة آمنة ومنع التكرار والأخطاء الجزئية
- [ ] P0: مراجعة الصلاحيات والخصوصية وإلغاء العمليات غير الذرية
- [ ] P0: إصلاح تداخل شريط الجوال واتجاه اللغة والاستجابة عبر المقاسات المعتمدة
- [ ] P1: إعادة بناء لوحة المنشأة حول مؤشرات تشغيلية حقيقية وحالة التوثيق والإجراءات التالية
- [ ] P1: توحيد إدارة الوظائف والمناوبات والمتقدمين وفصل أقسام المحتوى عن إجراء النشر
- [ ] P1: توحيد بحث المرشحين وبطاقاتهم وحالات التحميل والخطأ والفراغ والنجاح
- [ ] P1: تطبيق أنماط مشتركة للنماذج والحالات غير المتزامنة وإمكانية الوصول
- [ ] P2: ضبط نظام التصميم العربي RTL والمصطلحات والمسافات والحواف والظلال
- [ ] QA: اختبار الرحلات والصلاحيات والبيانات والاستجابة من 320px إلى 1440px+
