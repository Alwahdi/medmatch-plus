...
- [x] مراسلة داخل المنصة بين المنشأة والمرشح `/messages`
- [x] كشف هوية المنشأة عند بدء المحادثة أو ترقية الطلب (قائمة مختصرة فأعلى)
- [x] بحث المرشحين للمنشآت `/facility/candidates` مع خصم حصة الباقة
- [x] تفضيلات تنبيهات الوظائف (بريد/واتساب) `/alerts`
- [x] بناء الملف المهني من السيرة الذاتية بالذكاء الاصطناعي `/cv-import`
- [x] الوظائف المحفوظة `/saved` وصفحات التخصصات `/specialties`
- [ ] الإرسال الفعلي للتنبيهات (يحتاج مزود بريد + واتساب) — التفضيلات محفوظة فقط
