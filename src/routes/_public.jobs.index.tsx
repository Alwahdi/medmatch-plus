...
const TXT = {
  ...
  en: {
    ...
    scopeHintMine: (n: string) => `Showing your specialty: ${n} — widen to your field or all specialties.`,
    scopeHintField: "Showing your medical field — switch to your specialty only or all specialties.",
    scopeHintAll: "Showing all specialties — narrow to your specialty or your field.",
    emptyScope: "Results are limited to your specialty right now.",
    widenToField: "Widen to my field",
    widenToAll: "Show all specialties",
