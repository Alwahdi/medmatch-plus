...
const TXT = {
  ar: {
    ...
    why2: "بنينا SyndeoCare لتقصير هذه الدورة: ملف مهني موثّق مرة واحدة يُستخدم في كل طلب، وإعلانات واضحة النطاق المالي، وقناة تواصل مباشرة داخل المنصة بلا وسطاء.",
    createAccount: "إنشاء حساب",
    contactUs: "تواصل معنا",
    valuesLabel: "قيمنا",
    values: [
      { title: "الثقة أولاً", text: "نراجع التراخيص والوثائق قبل ظهور الملف للمنشآت." },
  ...
  en: {
    ...
    why2: "We built SyndeoCare to shorten this cycle: a professional profile verified once and reused for every application, listings with clear pay ranges, and a direct in-platform communication channel with no middlemen.",
    createAccount: "Create an account",
    contactUs: "Contact us",
    valuesLabel: "Our values",
    values: [
      { title: "Trust first", text: "We review licenses and documents before a profile appears to facilities." },
