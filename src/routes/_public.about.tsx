...
export const Route = createFileRoute("/_public/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "رسالتنا: توظيف صحي أوضح وأكثر شفافية في العالم العربي." },
...
const TXT = {
  ar: {
    ...
    whyTitle: "نقص الكوادر يستحق حلاً أوضح",
    ...
    values: [
      ...
      { title: "تغطية عاجلة", text: "المناوبة العاجلة تظهر فور نشرها للكوادر المسجّلة المطابقة." },
    ],
    readyTitle: "جاهز تبدأ؟",
    readyText: "التسجيل مجاني للكوادر الصحية وللمنشآت في النسخة الحالية.",
  },
  en: {
    ...
    whyTitle: "Staffing shortages deserve a clearer solution",
