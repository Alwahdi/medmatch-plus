...
export const TXT = {
  ar: {
    ...
    publishBlockedTitle: "النشر متاح بعد توثيق المنشأة",
    publishBlockedBody:
      "ارفع مستندات منشأتك ليراجعها فريق المنصة. بعد الاعتماد تستطيع نشر الوظائف والمناوبات مباشرة.",
    completeProfile: "أكمل بيانات منشأتك الأساسية",
    completeProfileBody: "الاسم ونوع المنشأة والدولة والمدينة مطلوبة قبل نشر الوظائف أو المناوبات أو التواصل مع المرشحين.",
    completeProfileCta: "إكمال بيانات المنشأة",
  ...
  en: {
    ...
    perHour: "/hr",
    lockedTerms: "Shift terms are locked after booking",
    open: "Open",
    bookedStatus: "Booked",
