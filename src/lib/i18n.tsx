...
export const DICT: Dict = {
  ...
  "footer.cookies": { ar: "التخزين وملفات الارتباط", en: "Browser storage" },
  ...
  "home.why.oneclick.text": {
    ar: "أرسل ملفك الطبي بنقرة واحدة — بدون نماذج طويلة ولا خطابات تعريف.",
    en: "Send your medical profile in one click — no long forms or cover letters.",
  },
  ...
  "home.why.free.title": { ar: "مجانية حالياً للباحثين عن عمل", en: "Currently free for job seekers" },
  "home.why.free.text": {
    ar: "مجانية حالياً للكوادر الصحية: الأطباء والتمريض والصيادلة والفنيين.",
    en: "Currently free for healthcare professionals: doctors, nurses, pharmacists, and technicians.",
  },
  ...
  "home.sides.pros.text": {
    ar: "ارفع سيرتك الذاتية ليساعدك الذكاء الاصطناعي على تحويلها إلى ملف مهني بسرعة، ثم تصفّح الوظائف والشيفتات مع ظهور حالة توثيق كل ناشر، وقدّم بنقرة واحدة.",
    en: "Upload your CV and AI helps turn it into a professional profile faster, then browse medical jobs and shifts with each employer's verification status shown, and apply in one click.",
  },
  ...
  "home.sides.employers.text": {
    ar: "انشر وظيفة أو شيفتاً، ويصلك تنبيه داخل المنصة عند تقدّم كادر مؤهّل.",
    en: "Post a job or shift and get an in-app notification when a qualified candidate applies.",
  },
  ...
  "home.steps.employer1.text": {
    ar: "انشر وظيفة دائمة أو شيفتاً عاجلاً عبر نموذج مختصر — ليظهر للكوادر الصحية المسجّلة بعد النشر.",
    en: "Post a permanent job or urgent shift through a short form — visible to registered healthcare candidates once published.",
  },
  ...
  "home.steps.seeker1.text": {
    ar: "يساعدك الذكاء الاصطناعي على تحويل سيرتك إلى ملف مهني بسرعة بدل ملء النماذج الطويلة.",
    en: "AI helps turn your CV into a professional profile faster instead of filling long forms.",
  },
  ...
  "home.ai.title": {
    ar: "ارفع سيرتك الذاتية، ودع الذكاء الاصطناعي يجهّز ملفّك المهني",
    en: "Upload your CV and let AI prepare your professional profile",
  },
  "home.ai.text": {
    ar: "لا مزيد من ملء النماذج الطويلة. ارفع سيرتك مرة واحدة ويساعدك ذكاء SyndeoCare الاصطناعي على تحويلها إلى ملف مهني متكامل — وابدأ التقديم على الوظائف والشيفتات بعد تجهيز ملفك.",
    en: "No more long forms. Upload your CV once and SyndeoCare AI helps turn it into a complete professional profile — then start applying to jobs and shifts as soon as it's ready.",
  },
  "home.ai.forPros": { ar: "للباحثين عن عمل", en: "For job seekers" },
  "home.ai.pros1": { ar: "تسجيل مختصر بدون نماذج طويلة", en: "A streamlined signup without long forms" },
  ...
  "home.ai.ctaPrimary": { ar: "أنشئ ملفك المهني", en: "Build your profile" },
  ...
  "home.cta.subtitle": {
    ar: "مجانية حالياً للكوادر الصحية، وتجربة 30 يوماً لناشري الوظائف.",
    en: "Currently free for healthcare professionals, with a 30-day trial for employers.",
  },
  ...
  "ob.subtitle": {
    ar: "خطوات قصيرة وتبدأ في استقبال الفرص المناسبة لك.",
    en: "A few short steps and you'll start getting the right opportunities.",
  },
  ...
  "ob.cvBody": {
    ar: "ارفعها ليساعدك الذكاء الاصطناعي على تعبئة ملفك المهني بسرعة.",
    en: "Upload it and AI helps fill your professional profile faster.",
  },
