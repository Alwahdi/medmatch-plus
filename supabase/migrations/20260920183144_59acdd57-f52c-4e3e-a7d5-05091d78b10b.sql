REVOKE EXECUTE ON FUNCTION public.guard_job_alert_system_state() FROM PUBLIC, anon;
REVOKE EXECUTE ON FUNCTION public.guard_message_insert_receipts() FROM PUBLIC, anon;
REVOKE EXECUTE ON FUNCTION public.guard_shift_terms_locked() FROM PUBLIC, anon;
REVOKE EXECUTE ON FUNCTION public.slugify(text) FROM PUBLIC, anon;
REVOKE EXECUTE ON FUNCTION public.is_known_city_country_valid(text, text) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.slugify(text) TO authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.is_known_city_country_valid(text, text) TO authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.guard_job_alert_system_state() TO service_role;
GRANT EXECUTE ON FUNCTION public.guard_message_insert_receipts() TO service_role;
GRANT EXECUTE ON FUNCTION public.guard_shift_terms_locked() TO service_role;
