...
REVOKE ALL ON FUNCTION public.search_candidates_idempotent(uuid, uuid, text, text, integer, integer) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.search_candidates_idempotent(uuid, uuid, text, text, integer, integer) FROM anon;
...
REVOKE ALL ON FUNCTION public.search_candidates_atomic(uuid, text, text, integer, integer) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.search_candidates_atomic(uuid, text, text, integer, integer) FROM anon;
REVOKE ALL ON FUNCTION public.search_candidates_atomic(uuid, text, text, integer, integer) FROM authenticated;
GRANT EXECUTE ON FUNCTION public.search_candidates_atomic(uuid, text, text, integer, integer) TO service_role;